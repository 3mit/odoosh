...
class IslrWhDoc(models.Model):
   ...
   # period_id = fields.Many2one(
    ...
    @api.model
    @api.constrains('Error! El socio debe ser un agente de retención de ingresos.',['partner_id'])
    ...
    # _constraints = [
    #     (_check_partner,'Error! El socio debe ser un agente de retención de ingresos.',['partner_id']),
    # ]
