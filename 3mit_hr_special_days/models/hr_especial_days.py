...
class HrSpecialDays(models.Model):
    ...
    def _compute_days(self):
        ...
        for slip in self:
            ...
            recursive_days = date_from = datetime.strptime(str(fecha_desde), DEFAULT_SERVER_DATE_FORMAT)
            date_to = datetime.strptime(str(fecha_hasta), DEFAULT_SERVER_DATE_FORMAT)
    ...
    mondays = fields.Integer('Nro lunes', help='este campo trae el numero de lunes', compute='_compute_days',
...
class HrPayrollHollydays(models.Model):
