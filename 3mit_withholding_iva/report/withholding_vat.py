...
class IvaReport(models.AbstractModel):
    _name = 'report.3mit_withholding_iva.template_wh_vat'
    _description = 'report.3mit_withholding_iva.template_wh_vat'
    #_name = 'report.3mit_withholding_iva.template_wh_vat'

    #_inherit = 'report.abstract_report'
    #_template = '3mit_withholding_iva.template_wh_vat'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {
            'data': data['form'],
            'model': self.env['report.3mit_withholding_iva.template_wh_vat'],
